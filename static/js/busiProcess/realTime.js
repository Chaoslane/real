		...
		var socket = io.connect('http://218.206.203.241:18090/realhook');
	        ...
	        /*$('#total_uv').text(JSON.stringify(data, null, '\t'));*/        
	       	//调用生成图片文字 所有累计的数据——uv iuv 
	        	...
	        	var y4 = data.campaigns[choose].isuc_rate*100;
		      ...
		      //当前查询成功率
		         ...
		         $("#dqcxcgl-sz").html((dqcxcgl_sz*100).toFixed(2)+"%");
		...
		var socket = io.connect('http://218.206.203.241:18090/realhook');
	        ...
	        /*$('#total_uv').text(JSON.stringify(data, null, '\t'));*/        
	       	//调用生成图片文字 所有累计的数据——uv iuv 
	        	...
	        	var y4 = data.campaigns[choose2].isuc_rate*100;
		      ...
		      //当前办理成功率
		         ...
		         $("#dqblcgl-sz").html((dqblcgl_sz*100).toFixed(2)+"%");
